...
<article>
    ...
    <form id="join" action="TohomeServlet?command=join" method="post" name="formm">
        <fieldset>
            ...
            핸드폰번호 : <input type="text" id="mobile_num" name="mobile_num" value=""/><br />
            성별 : <span><input type="radio"   name="gender" value="1" onclick='getGender(event)'>남자 <input type="radio"  name="gender" value="0" onclick='getGender(event)'>여자</span><br />
            <font id="gender" value="" style="display:none;" ></font>
            주소 : <input type=text name="main_address" id="adress" value=""> <input type="button" id="address_kakao" name="address" value="주소검색" readonly /><br />
            상세 주소: <input type="text" id="address_detail" name="address_detail" value=""/> <br />
            주소 별명: <input type="text" id="address_name" name="address_name" placeholder="별명 :ex) 집, 회사 " value=""> <br />
